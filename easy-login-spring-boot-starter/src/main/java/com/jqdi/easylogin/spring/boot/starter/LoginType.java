...
public interface LoginType {
	...
	String USERNAME_PASSWORD_CODE = "usernamePasswordCode";// 用户名+密码+验证码
	String MOBILE_PASSWORD_CODE = "mobilePasswordCode";// 手机号+密码+验证码
	String EMAIL_PASSWORD_CODE = "emailPasswordCode";// 邮箱+密码+验证码
